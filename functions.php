...
require_once('admin/hummelt-theme-v3-bootstrap.php');             // Theme Admin Options
...
require_once('inc/top-area-navwalker.php');      // Register the Bootstrap 5 navwalker
...
$myUpdateChecker = PucFactory::buildUpdateChecker(
    'https://produkte.hu-ku.com/api/hummelt-theme-v3/update/update-options',
    __FILE__,
    'hummelt-theme-v3'
);