...
export const dropzoneUpload = (callback, formValue, container, template, builder_id, form_id, grid_id) => {
    ...
    uploadDropzone = new Dropzone(dropzoneContainer, {
        ...
        init: function () {
            ...
            this.on("sending", function (file, xhr, formData) {
                ...
                formData.append("form_data", JSON.stringify(ids))
